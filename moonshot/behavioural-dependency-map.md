...
Implement in-memory `validate_chain` over `Memory_Ledger` events. This is
smaller than SQLite persistence and directly uses the appended event order,
parent hashes, and migrated `compute_event_hash`.
